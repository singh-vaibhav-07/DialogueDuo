...
import com.codewithvaibhav.videochat.databinding.ActivityCallBinding;
import com.codewithvaibhav.videochat.models.InterfaceJava;
...
//                super.onPermissionRequest(request);
    ...
    void sendCallRequest(){
        if(!isPeerConnected){
            Toast.makeText(this, "You are not connected. Please check your internet speed.", Toast.LENGTH_SHORT).show();
            return;
        }
